...
export default function IdealTradeCard({ stats, storageKey }) {
  const [open, toggle] = useCollapsed(`${storageKey}:idealTrade`)
  ...
  const hasAvoid = (worstSession && worstSession[1].pnl < 0) || (worstDay && worstDay[1].pnl < 0) || (worstEmotion && worstEmotion[1].pnl < 0)

  return (
    <div className={styles.card}>
      <div className={styles.title}>
        <span>Profilo del trade ideale</span>
      ...
      <div className={styles.compareGrid}>
        <div className={styles.goodCol}>
          <div className={styles.colTitle}>Da seguire</div>
        ...
        {hasAvoid && (
          <div className={styles.badCol}>
            <div className={styles.colTitle}>Da evitare</div>
            <div className={styles.list}>
